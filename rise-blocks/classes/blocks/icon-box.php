			...
			foreach( $this->blocks as $block ){
				...
				if( isset( $attrs[ 'iconColors' ] ) ){
					...
					if(isset( $attrs[ 'iconColors' ][ $activeLayout ][ 'color' ] ) ){
						$icon_props[ 'color' ] = [ 'value'=> $attrs[ 'iconColors' ][ $activeLayout][ 'color' ] ];
					}
					if( 'frame' === $activeLayout && isset( $attrs[ 'iconColors' ][ $activeLayout ][ 'borderColor' ] ) ){
						$icon_props[ 'border-color' ] = [ 'value' => $attrs[ 'iconColors' ][ $activeLayout ][ 'borderColor' ] ];
					}else if( 'stack' === $activeLayout && $attrs[ 'iconColors' ][ $activeLayout ][ 'backgroundColor' ] ){
						$icon_props[ 'background-color' ] = [ 'value' => $attrs[ 'iconColors' ][ $activeLayout ][ 'backgroundColor' ] ];
					}
				}
				
				if( 'frame' == $attrs[ 'activeIconLayout' ] ){
					$icon_props[ 'border-width' ] = [ 'value' => $attrs[ 'iconBorderWidth' ], 'unit'=>'px' ];
				}
